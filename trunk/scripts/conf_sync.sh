...
CONF_MNT="/mnt/conf"
ETC_FILES="passwd group shadow network hostname hosts ssh_host_rsa_key.pub ssh_host_rsa_key ssh_host_ecdsa_key.pub ssh_host_ecdsa_key ssh_host_dsa_key.pub ssh_host_dsa_key random-seed resolv.conf revaliases ssmtp.conf"
